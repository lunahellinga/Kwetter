...
using MentionService.Extensions;
using MentionService.Services;
...
public class Program
{
    ...
    public static IHostBuilder CreateHostBuilder(string[] args)
    {
        return Host.CreateDefaultBuilder(args)
            ...
            .ConfigureServices((hostContext, services) =>
            {
                services.AddScoped<IMentionFinderService, MentionFinderService>();
                services.AddScoped<IMentionManagerService, MentionManagerService>();
            });
    }
}